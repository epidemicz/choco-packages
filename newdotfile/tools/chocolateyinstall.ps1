...
$packageName= 'newdotfile' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://github.com/epidemicz/newdotfile/releases/download/1.0.0/newdotfile-release-1.0.0.zip' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'newdotfile*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
